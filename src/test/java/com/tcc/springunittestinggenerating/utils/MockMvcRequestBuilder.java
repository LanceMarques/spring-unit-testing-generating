...
public class MockMvcRequestBuilder {
    ...
    public MockMvcRequestBuilder(MockMvc mockMvc, MockHttpServletRequestBuilder servletRequestBuilder) {
    ...
    public MockMvcResponseBuilder expect204() {
        return perform().expect204();
    }
